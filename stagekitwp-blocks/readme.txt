...
* **Bookshelf Item**: An affiliate book card that can parse Amazon links, build affiliate URLs, and retrieve book metadata from public book services.
...
The Post Carousel uses the Slick Carousel assets supplied through jsDelivr. Bookshelf metadata lookup can use the Google Books API and Open Library API when an ISBN is provided.
