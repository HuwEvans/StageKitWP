<?php
/**
 * Title: Post Full Feature
 * Slug: stagekitwp-theme/posts-full-feature
 * Categories: stagekitwp-theme, query
 * Block Types: core/query
 * Post Types: page, post
 * Description: Single recent post in a full feature layout with large image and long excerpt.
 */
?>
<!-- wp:query {"queryId":4,"query":{"perPage":1,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"displayLayout":{"type":"list"},"align":"wide"} -->
...
<!-- wp:post-excerpt {"moreText":"Read the full post","excerptLength":55} /--></div>
<!-- /wp:group -->
