# StageKitWP Blocks - Comprehensive Guide

## Overview

StageKitWP provides a complete suite of 20 Gutenberg blocks:
- **Show Landing Page**: Standalone block with advanced features (drag-to-reorder fields, live preview)
- **19 Other Blocks**: Unified group under "StageKitWP Blocks" category with visual configuration
...
### Unified StageKitWP Blocks Group (19 blocks)
...
- **Parameters**:
  - View: `grid` or `slider`
  - Category: Filter by category (e.g. `restaurant`)
  - Slider Image: `banner` or `logo` (slider view only)
  - Columns: Grid column count (1-6)
  - Lock Column Count: Force the exact column count instead of responsive auto-fit
  - Mini Logos: Render smaller logo thumbnails
...
3. **Find Block**: Search in "StageKitWP Blocks" category OR search by name
...
```css
.stagekitwp-entry { /* Customize entry styling */ }
.stagekitwp-cast-image { /* Customize cast images */ }
.stagekitwp-show-title { /* Customize show names */ }
```
...
### Block Names
- `stagekitwp/landingpage`
- `stagekitwp/stagekitwp-shows`
- `stagekitwp/stagekitwp-cast`
- `stagekitwp/stagekitwp-board-members`
- `stagekitwp/stagekitwp-sponsors`
- `stagekitwp/stagekitwp-advertisers`
- `stagekitwp/stagekitwp-seasons`
- `stagekitwp/stagekitwp-venues`
- `stagekitwp/stagekitwp-testimonials`
- `stagekitwp/stagekitwp-awards`
- `stagekitwp/stagekitwp-contributors`
- `stagekitwp/stagekitwp-auditions`
- `stagekitwp/stagekitwp-sponsor-slider`
- `stagekitwp/stagekitwp-season-banner`
- `stagekitwp/stagekitwp-season-shows`
- `stagekitwp/stagekitwp-season-cast`
- `stagekitwp/stagekitwp-season-images`
- `stagekitwp/stagekitwp-cast-show`
- `stagekitwp/stagekitwp-programs`
- `stagekitwp/stagekitwp-tickets`

## Support

For issues with specific blocks, check the StageKitWP documentation or contact support at https://miltonplayers.com/plugin
