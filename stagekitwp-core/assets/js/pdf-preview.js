 ...
 * Elements: <canvas class="stagekitwp-pdf-canvas" data-pdf="/path/to/file.pdf" data-width="300"></canvas>
 */
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var canvases = document.querySelectorAll('.stagekitwp-pdf-canvas');
