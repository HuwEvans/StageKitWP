# StageKitWP - Show Landing Page Gutenberg Block

## Overview

The Show Landing Page Gutenberg block provides an intuitive interface for inserting `stagekitwp_landingpage` shortcodes into WordPress pages using the block editor.
...
### Generated Shortcode
The block generates a `stagekitwp_landingpage` shortcode with the following attributes:
...
- Verify `stagekitwp_landingpage` shortcode is registered
